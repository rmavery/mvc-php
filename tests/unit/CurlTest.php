...
/**
 * Unit tests for sys/classes/Curl.php
 * As they depend on external services, in case of failure of tests, the availability of these services should be checked.
 */
