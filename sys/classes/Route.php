...
/**
 * The class that defines the route.
 */
final class Route {
	 ...
	 * @param string $method Name of controller method
	...
	/**
	 * Checks if the route is appropriate
	 * @param string $request a request
	 * @param null $args Variable passed by reference in which we will save any arguments when requesting
	 * @return bool
	 */
