...
class Curl {
	...
	/**
	 * The number of seconds the cURL function is allowed to execute
	 * @var int
	 */
	const TIMEOUT = 3;
	 ...
	 * @param array|bool $query Query (can also be passed through the URL for GET requests)
	 * @param array|bool $headers Headers - check the white list
