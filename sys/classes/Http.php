...
final class Http {
	...
	/**
	 * Detects whether it is an HTTP GET request
	 * @return bool
	 */
	...
	/**
	 * Detects whether it is an HTTP POST request
	 * @return bool
	 */
	...
	/**
	 * Checks if the appropriate HTTP method is involved
	...
	/**
	 * Detects whether HTTPS has been used
	...
	/**
	 * Normalizes and restores the required path
	 * @return string
	 */
