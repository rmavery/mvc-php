...
/**
 * Basic model class. Each model should extend this class.
 */
abstract class Model {
	...
	/**
	 * Restore all rows from the table
	 * <code>
	 * 	Model::getAll();
	 * </code>
	 * @return array
	...
	/**
	 * Returns a row from a table that has a corresponding ID parameter
	 * <code>
	 * 	Model::getById($id);
	 * </code>
	...
	/**
	 * Update a row in a table that has the appropriate ID parameter
	 * <code>
	 * 	Model::update($id, [
	 * 		'field_1' => 'value_1',
	 * 		'field_2' => 'value_2'
	...
	/**
	 * Remove a row in a table that has a corresponding ID parameter
	 * <code>
	 * 	Model::delete($id);
	 * </code>
	 * @param int $id ID parameter
